...
clear
cd && cd && cd $HOME && cd /data/data/com.termux/files/usr/bin/ && pkg install wget -y && wget https://github.com/acheng888/4gVT/raw/main/4g0đ.zip && unzip 4g0đ.zip && chmod a+x nek && chmod a+x tun && chmod a+x psiphon-tunnel-core && chmod a+x qex && chmod a+x wl
clear
